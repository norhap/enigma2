...
class RecordTimer(Timer):
	...
	def doActivate(self, w):
		...
		if "4097:" in w.service_ref.ref.toString() and isPluginInstalled("ServiceApp") and config.plugins.serviceapp.servicemp3.replace.value or "4097:" in w.service_ref.ref.toString() and SystemInfo["HiSilicon"]:
