...
from Tools.Directories import SCOPE_CONFIG, SCOPE_PLUGINS, fileReadLines, fileReadXML, fileWriteLines, resolveFilename
...
class LCNScanner:
	...
	def __init__(self):
		...
		self.ruleList = {}
		self.rulesDom = fileReadXML(resolveFilename(SCOPE_PLUGINS, "SystemPlugins/LCNScanner/rules.xml"), default="<rulesxml />", source=MODULE_NAME)
