...
from os.path import dirname, getmtime, isfile, join, splitext
		...
		for element in domSkin:
			match element.tag:
				...
				case "windowstyle":  # Process the windowstyle element.
					scrnID = element.attrib.get("id")
					if scrnID is None or scrnID == screenID:  # Without an scrnID, it is useless!
...
def reloadSkinTemplates(clear=False):
	...
	skinTemplatesFileName = resolveFilename(SCOPE_GUISKIN, join(dirname(str(currentPrimarySkin)), "skinTemplates.xml"))
