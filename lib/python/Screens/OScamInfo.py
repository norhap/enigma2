...
class OSCamInfoCapability(Screen, OSCamGlobals):
	skin = """
		<screen name="OSCamInfoCapability" position="center,center" size="1920,1080" backgroundColor="#10101010" title="OSCamInfo Capabilities" flags="wfNoBorder" resolution="1920,1080">
			...
			<widget name="captext" position="15,70" size="1890,995" font="Fixed;24" horizontalAlignment="left" verticalAlignment="top" foregroundColor="black" backgroundColor="#ECEAF6" noWrap="0" scrollbarMode="showOnDemand" scrollbarForegroundColor="black" />
		</screen>
		"""
...
class OSCamInfoLog(Screen, OSCamGlobals):
	skin = """
		<screen name="OSCamInfoLog" position="center,center" size="1920,1080" backgroundColor="#10101010" title="OSCamInfo Log" flags="wfNoBorder" resolution="1920,1080">
			...
			<widget name="logtext" position="15,70" size="1890,995" font="Regular;24" horizontalAlignment="left" verticalAlignment="top" foregroundColor="black" backgroundColor="#ECEAF6" noWrap="0" scrollbarMode="showOnDemand" scrollbarForegroundColor="black" />
		</screen>
		"""
