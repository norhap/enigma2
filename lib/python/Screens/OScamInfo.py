...
class OSCamInfo(Screen, OSCamGlobals):
	...
	def onLayoutFinished(self):
		...
		if config.oscaminfo.userDataFromConf.value and self.confPath()[0] is None:
			...
			self["extrainfos"].setText(_("File oscam.conf not found.\nPlease enter username/password manually.") if getSysSoftcam() == "OSCam" else _("File ncam.conf not found.\nPlease enter username/password manually."))
		else:
	...
	def updateOScamData(self):
		if getSysSoftcam() == "OSCam":
			self['camlogo'].instance.setPixmapFromFile("/usr/share/enigma2/skin_default/icons/OscamLogo.png")
		else:
			self['camlogo'].instance.setPixmapFromFile("/usr/share/enigma2/skin_default/icons/NCamLogo.png")
		try:
...
class OSCamEntitlements(Screen, OSCamGlobals):
	skin = """
		<screen name="OSCamEntitlements" position="center,center" size="1920,1080" backgroundColor="#10101010" title="OSCam Entitlements" flags="wfNoBorder" resolution="1920,1080">
			...
			<widget source="key_blue" render="Label" position="1170,1020" size="380,42" font="Regular;30" horizontalAlignment="left" verticalAlignment="center" foregroundColor="grey" objectTypes="key_blue,StaticText">
				<convert type="ConditionalShowHide" />
			</widget>
			<widget source="key_OK" render="Label" position="1395,1020" size="60,42" font="Regular;30" horizontalAlignment="center" verticalAlignment="center" foregroundColor="black" backgroundColor="grey">
				<convert type="ConditionalShowHide" />
			</widget>
...
class OSCamInfoCapability(Screen, OSCamGlobals):
	skin = """
		<screen name="OSCamInfoCapability" position="center,center" size="1920,1080" backgroundColor="#10101010" title="OSCamInfo Capabilities" flags="wfNoBorder" resolution="1920,1080">
			<widget source="Title" render="Label" position="15,15" size="1905,60" font="Regular;40" horizontalAlignment="center" verticalAlignment="center" foregroundColor="white" backgroundColor="#10101010" />
			<widget source="global.CurrentTime" render="Label" position="1635,15" size="260,60" font="Regular;40" horizontalAlignment="right" verticalAlignment="center" foregroundColor="#0092CBDF" backgroundColor="#10101010">
				<convert type="ClockToText">Format:%H:%M:%S</convert>
			</widget>
			<widget name="captext" position="15,70" size="1890,995" font="Fixed;24" horizontalAlignment="left" verticalAlignment="top" padding="10,0,10,0"  foregroundColor="black" backgroundColor="#ECEAF6" noWrap="0" scrollbarMode="showOnDemand" scrollbarForegroundColor="black" />
		</screen>
		"""
...
class OSCamInfoLog(Screen, OSCamGlobals):
	skin = """
		<screen name="OSCamInfoLog" position="center,center" size="1920,1080" backgroundColor="#10101010" title="OSCamInfo Log" flags="wfNoBorder" resolution="1920,1080">
			...
			<widget name="logtext" position="15,70" size="1890,995" font="Regular;24" horizontalAlignment="left" verticalAlignment="top" padding="10,0,10,0"  foregroundColor="black" backgroundColor="#ECEAF6" noWrap="0" scrollbarMode="showOnDemand" scrollbarForegroundColor="black" />
		</screen>
		"""
