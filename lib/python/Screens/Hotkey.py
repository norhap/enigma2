...
class hotkey:
	...
	hotkeys = [(_("Red") + " " + _("long"), "red_long", "Infobar/activateRedButton"),
		...
		(_("Blue"), "blue", ""),
		(_("Rec"), "rec", ""),
		(_("Rec") + " " + _("long"), "rec_long", "Infobar/instantRecord"),
		("Radio", "radio", ""),
		...
		(_("Teletext"), "text", ""),
		(_("Help"), "displayHelp", ""),
		(_("Help") + " " + _("long"), "displayHelp_long", ""),
		(_("Subtitle"), "subtitle", ""),
		(_("Subtitle") + " " + _("long"), "subtitle_long", ""),
		("Menu", "mainMenu", ""),
		("Info (EPG)", "info", "Infobar/openEventView"),
		("Info (EPG)" + " " + _("long"), "info_long", "Infobar/showEventInfoPlugins"),
		(_("PlayList/PVR"), "list", ""),
		(_("PlayList/PVR") + " " + _("long"), "list_long", "Plugins/Extensions/Kodi/1"),
		(_("List/File"), "file", ""),
		...
		(_("EPG/Guide") + " " + _("long"), "epg_long", "Infobar/showEventInfoPlugins"),
		(_("Left"), "cross_left", ""),
		(_("Right"), "cross_right", ""),
		(_("Up"), "cross_up", ""),
		(_("Down"), "cross_down", ""),
		(_("Page up"), "pageUp", ""),
		(_("Page up") + " " + _("long"), "pageUp_long", ""),
		(_("Page down"), "pageDown", ""),
		(_("Page down") + " " + _("long"), "pageDown_long", ""),
		(_("Next"), "next", ""),
		(_("Previous"), "previous", ""),
		(_("Audio"), "audio", ""),
		("Play", "play", ""),
		...
		(_("Activate PiP") + " " + _("long"), "activatePiP_long", ""),
		(_("History"), "history", ""),
		(_("History") + " " + _("long"), "history_long", ""),
		(_("Timer"), "timer", ""),
		(_("Timer") + " " + _("long"), "timer_long", ""),
		(_("Playlist"), "playlist", ""),
		(_("Timeshift"), "timeshift", ""),
		(_("Search"), "search", ""),
		(_("Search") + " " + _("long"), "search_long", ""),
		(_("Slow"), "slow", ""),
		(_("Mark/Portal/Playlist"), "mark", ""),
		(_("Mark/Portal/Playlist") + " " + _("long"), "mark_long", ""),
		(_("Sleep"), "sleep", ""),
		(_("Sleep") + " " + _("long"), "sleep_long", ""),
		(_("Context"), "contextmenu", ""),
		(_("Context") + " " + _("long"), "contextmenu_long", ""),
		(_("Video Mode"), "vmode", ""),
		(_("Video Mode") + " " + _("long"), "vmode_long", ""),
		(_("Home"), "home", ""),
		(_("Power"), "power", "Module/Screens.Standby/Standby"),
		(_("Power") + " " + _("long"), "power_long", "Menu/shutdown"),
		...
		(_("Open"), "open", ""),
		(_("Open") + " " + _("long"), "open_long", ""),
		(_("Option"), "option", ""),
		(_("Option") + " " + _("long"), "option_long", ""),
		(_("Favorites"), "favorites", "Infobar/openFavouritesList"),
		(_("Favorites") + " " + _("long"), "favorites_long", ""),
		(_("Mouse"), "mouse", ""),
		(_("Mouse") + " " + _("long"), "mouse_long", ""),
		(_("Directory"), "directory", ""),
		(_("Directory") + " " + _("long"), "directory_long", ""),
		(_("Sat"), "sat", ""),
		(_("Sat") + " " + _("long"), "sat_long", ""),
		(_("Prov"), "prov", ""),
		(_("Prov") + " " + _("long"), "prov_long", ""),
		("LAN", "lan", ""),
		("LAN" + " " + _("long"), "lan_long", ""),
		("PC", "pc", ""),
		("PC" + " " + _("long"), "pc_long", ""),
		(_("Homepage"), "homepage", ""),
		(_("Homepage") + " " + _("long"), "homepage_long", ""),
		("EjectCD", "ejectcd", ""),
...
def getHotkeyFunctions():
	...
	hotkey.functions.append((_("Fallback remote receiver setup"), "Module/Screens.SetupFallbacktuner/SetupFallbacktuner", "Setup"))
	...
	hotkey.functions.append(("OSCam Info", "Module/Screens.OScamInfo/OSCamInfo", "Setup"))
	hotkey.functions.append(("CCcam Info", "Module/Screens.CCcamInfo/CCcamInfoMain", "Setup"))
