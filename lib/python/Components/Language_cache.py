...
LANGUAGE_AI = {
	"ar": ("Arabic", "AE", "ISO-8859-15"),
	"bg": ("Български", "BG", "ISO-8859-15"),
	"nb": ("Norsk Bokmål", "NO", "ISO-8859-15"),
	"ca": ("Català", "AD", "ISO-8859-15"),
	"cs": ("Česky", "CZ", "ISO-8859-15"),
	"zh": ("Chinese", "CN", "HK", "UTF-8"),
	"da": ("Dansk", "DK", "ISO-8859-15"),
	"de": ("Deutsch", "DE", "ISO-8859-15"),
	"el": ("Ελληνικά", "GR", "ISO-8859-7"),
	"en": ("English (AU)", "GB", "US", "ISO-8859-15"),
	"es": ("Español", "ES", "ISO-8859-15"),
	"et": ("Eesti", "EE", "ISO-8859-15"),
	"fa": ("Persian", "IR", "ISO-8859-15"),
	"fi": ("Suomi", "FI", "ISO-8859-15"),
	"fr": ("Français", "FR", "ISO-8859-15"),
	"fy": ("Frysk", "NL", "ISO-8859-15"),
	"he": ("Hebrew", "IL", "ISO-8859-15"),
	"hr": ("Hrvatski", "HR", "ISO-8859-15"),
	"hu": ("Magyar", "HU", "ISO-8859-15"),
	"id": ("Indonesian", "ID", "ISO-8859-15"),
	"is": ("Íslenska", "IS", "ISO-8859-15"),
	"it": ("Italiano", "IT", "ISO-8859-15"),
	"ku": ("Kurdish", "KU", "ISO-8859-15"),
	"lt": ("Lietuvių", "LT", "ISO-8859-15"),
	"lv": ("Latviešu", "LV", "ISO-8859-15"),
	"nl": ("Nederlands", "NL", "ISO-8859-15"),
	"no": ("Norsk", "NO", "ISO-8859-15"),
	"pl": ("Polski", "PL", "ISO-8859-15"),
	"pt": ("Portuguese", "PT", "BR", "ISO-8859-15"),
	"ro": ("Romanian", "RO", "ISO-8859-15"),
	"ru": ("Русский", "RU", "ISO-8859-15"),
	"sk": ("Slovensky", "SK", "ISO-8859-15"),
	"sl": ("Slovenščina", "SI", "ISO-8859-15"),
	"sr": ("Srpski", "YU", "ISO-8859-15"),
	"sv": ("Svenska", "SE", "ISO-8859-15"),
	"th": ("ภาษาไทย", "TH", "ISO-8859-15"),
	"tr": ("Türkçe", "TR", "ISO-8859-15"),
	"uk": ("Українська", "UA", "ISO-8859-15"),
	"vi": ("Tiếng Việt", "VN", "UTF-8")
}
