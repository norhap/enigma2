...
SystemInfo["HasFBCtuner"] = ["Vuplus DVB-C NIM(BCM3158)", "Vuplus DVB-C NIM(BCM3148)", "Vuplus DVB-S NIM(7376 FBC)", "Vuplus DVB-S NIM(45308X FBC)", "Vuplus DVB-S NIM(45208 FBC)", "DVB-S NIM(45208 FBC)", "DVB-S2 NIM(45208 FBC)", "DVB-S2X NIM(45308X FBC)", "DVB-S2 NIM(45308 FBC)", "DVB-C NIM(3128 FBC)", "BCM45208", "BCM45308X", "BCM3158"]
...
SystemInfo["DisplayLED"] = SystemInfo["FrontpanelDisplay"] and MODEL not in ("vusolo4k", "vuduo4k", "vuduo4kse", "vuultimo4k", "vuuno4k", "vuuno4kse", "atemionemesis", "h17")
SystemInfo["DisplayREC"] = SystemInfo["FrontpanelDisplay"] and MODEL not in ("h17",)
...
SystemInfo["RcTypeChangable"] = not (MODEL in ("gbquad4k", "gbue4k") or MODEL.startswith("et7")) and pathExists("/proc/stb/ir/rc/type")
...
SystemInfo["canBackupEMC"] = MODEL in ("hd51", "h7", "h17") and ("disk.img", f'{SystemInfo["MultibootStartupDevice"]}') or MODEL in ("xc7439", "osmio4k", "osmio4kplus", "osmini4k") and ("emmc.img", f'{SystemInfo["MultibootStartupDevice"]}') or SystemInfo["DefineSat"] and ("usb_update.bin", "none") or MODEL in ("cc1", "sx988", "ip8", "ustym4kottpremium", "og2ott4k", "og2s4k", "sx88v2") and ("usb_update.bin", "none")
