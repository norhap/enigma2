...
class PliExtraInfo(Poll, Converter):
	...
	def createResolution(self, info):
		if (os.path.isfile("/proc/stb/vmpeg/0/yres")):
			...
			try:
				...
				pass
			f.close()
		if (os.path.isfile("/proc/stb/vmpeg/0/xres")):
			...
			try:
				...
				pass
			f.close()
		if (os.path.isfile("/proc/stb/vmpeg/0/progressive")):
			...
			try:
				...
				pass
			f.close()
		if (os.path.isfile("/proc/stb/vmpeg/0/framerate")):
