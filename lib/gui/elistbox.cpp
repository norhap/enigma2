...
ePoint eListbox::defaultPadding = ePoint(1,1);
	...
	m_items_per_page(0), m_selection_enabled(1), m_page_size(0), m_native_keys_bound(false), m_first_selectable_item(-1),m_last_selectable_item(-1),m_scrollbar(nullptr)
{
	...
	m_style.m_text_offset = eListbox::defaultPadding;
...
void eListbox::setTextPadding(const ePoint &padding)
{
	m_style.m_text_offset = padding;
}
