...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "Vision-Turquoise-HD/skin.xml" or "PLi-FullNightHD/skin.xml"  # SD hardware is no longer supported by the default skin.
